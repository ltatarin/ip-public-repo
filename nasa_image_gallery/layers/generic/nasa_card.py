class NASACard:
    ...
    def __str__(self):
        return f'Título: {self.title}, Descripción: {self.description}, Comentario: {self.comment}, URL de la imagen: {self.image_url}, Fecha: {self.date}, Usuario: {self.user}, Id: {self.id}'
